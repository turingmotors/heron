...
class GitGPT2Config(GPT2Config):
    model_type = "git_gpt2"
...
class GitGPT2Model(GPT2Model):
    config_class = GitGPT2Config

    def __init__(self, config: GPT2Config):
        super(GitGPT2Model, self).__init__(config)
    ...
    def forward(
        ...
        if position_ids is None:
            ...
            position_ids_text = position_ids_text.unsqueeze(0)
        position_embeds = self.wpe(position_ids_text)
        ...
        embedding_output = self.drop(inputs_embeds)
...
class GitGPT2ForCausalLM(GPT2LMHeadModel):
    config_class = GitGPT2Config
    ...
    def __init__(
        ...
        super(GitGPT2ForCausalLM, self).__init__(config)
        self.transformer = GitGPT2Model(config)
